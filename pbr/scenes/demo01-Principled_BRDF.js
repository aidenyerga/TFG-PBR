...
document.title = "BRDF - Scene: Demo 1 [Principled BRDF]";
...
// Geometry
var plane = new THREE.Mesh(new THREE.PlaneBufferGeometry( 10, 10, 10 ), materials.principled.plastic.clone() );
...
var objects =
{
	...
	shaders: ["principled", "principled", "principled", "principled"]
};
